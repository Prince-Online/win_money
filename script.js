function getUsernameFromLocalStorage() {
  return localStorage.getItem('win_local');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbzB21MmJUI7uV2ZxTov-gdR6mBAyjb1C93FYZVM10PifSZWLX1rzmavBcWSYghNPaYr1A/exec';
