const localUsername = localStorage.getItem('win_local');

async function fetchUserData(username) {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbzf65gKQQCOIAjT1YfOUwC2PXDCq7bZdkiNeCPjgVIdLraWksKC_VATnvPBsG2valmkKQ/exec?username=' + username);
