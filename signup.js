const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwRyoI1jXrcHaSKj2isO3bWaUaprNWx3jJ4ZSiPv5aQBO49Y0RXeAq6GVhCtFKOBp7j/exec";
...
async function submitData() {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            localStorage.setItem('win_local', formData.username);
