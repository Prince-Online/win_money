const username = localStorage.getItem('win_local');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzEwahqq0LuIdX4Hy8i7yJwKyBWpfcF0wfpDd3WyFOf0pa0u2q7qAc5On0PaxnaGITCyA/exec';
